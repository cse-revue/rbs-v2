...
class MigrateOldDatabase extends Migration {
    ...
    public function up()
    {
        ...
        Schema::create('production', function($table) {
            ...
            $table->string('sitelocation', 60);
            $table->string('bookingslocation', 60);
            $table->string('faqlocation', 60);
            $table->string('salesemail', 60);
            $table->text('salesinfo');
            $table->boolean('acceptsales');
            $table->boolean('acceptdd');
            $table->boolean('acceptpaypal');
            $table->string('paypalaccount', 50)->nullable();
            $table->text('paypalinfo')->nullable();
            $table->text('ddinfo')->nullable();
            $table->unsignedInteger('groupticketsamount');
            $table->boolean('acceptstripe')->nullable();
            $table->string('stripepublishablekey', 255)->nullable();
            $table->string('stripesecretkey', 255)->nullable();
            $table->string('stripeinfo', 255)->nullable();
        });
